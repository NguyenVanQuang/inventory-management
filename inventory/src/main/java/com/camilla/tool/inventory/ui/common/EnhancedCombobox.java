...
public class EnhancedCombobox extends PlainDocument {

  private static final long serialVersionUID = -3154768102708154853L;
  ...
  public EnhancedCombobox(final JComboBox<String> comboBox) {
  ...
  private static void createAndShowGUI() {
    ...
    JComboBox<String> comboBox =
        new JComboBox<String>(new String[] {"Huy", "Ester", "Jordi", "Jordina", "Jorge", "Sergi"});
    // has to be editable
    comboBox.setEditable(true);
    // change the editor's document
    new EnhancedCombobox(comboBox);
